 ...
 * - Содержится бизнес логика в контрллере (проверка на роль, отправка в редис), ее нужно вынести в отдельные сервисы
 * - Использование exit;
 * - Magic Number - 10, 201. Это антипаттерн, число должно находиться в осмысленной константе
 ...
 * - Зависимость на суперглобальную переменную $_POST - плохая практика. Данные в нем не иммутабельны и могут быть изменены в других частях кода
 */
